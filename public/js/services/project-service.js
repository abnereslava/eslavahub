...
const PROJECT_STATUS_CYCLE = new Map([
  ...
  [PROJECT_STATUS_CODES.DOCUMENTED, 20],
  [PROJECT_STATUS_CODES.IN_DEVELOPMENT, 30],
  [PROJECT_STATUS_CODES.PAUSED, 35],
  [PROJECT_STATUS_CODES.FUNCTIONAL, 40],
  [PROJECT_STATUS_CODES.FINISHED, 50],
  [PROJECT_STATUS_CODES.ABANDONED, 60]
]);
